# Families in the Bible Image Style

- **Logo file:** `series-logo.png`
- **Logo format:** 1254 × 1254 PNG with a transparent alpha background
- **Logo silhouette:** stacked lettering beneath a welcoming stone home, framed by olive branches, with an open Bible at the base
- **Series cover file:** `cover-graphic.png`
- **Church cover file:** `bethel-baptist-jr-church-cover.png`
- **Presentation background file:** `presentation-background.png`
- **Series image canvas:** 16:9 PNG, 1672 × 941 to match Adventures in the Bible
- **Art style:** polished children's storybook illustration with painted textures, dimensional cartoon forms, clear silhouettes, navy depth, and white outlines around title art
...
- **Do reuse:** illustrated dimensional lettering, warm painted materials, Bible-times clothing, gentle expressions, and clear classroom readability
- **Avoid:** adventure equipment, weapons, ships, maps, crowded text areas, modern objects in Bible scenes, frightening imagery, and script-rendered lettering
...
- **Logo:** Create a transparent roughly square FAMILIES / in the / BIBLE emblem using the Adventures logo as a style reference. Use golden-orange main lettering, a cream ribbon, colorful BIBLE letters, navy depth, and white outlines. Frame a welcoming ancient stone home and open Bible with olive branches. Keep a transparent margin and omit adventure equipment.
- **Series cover base:** Create a wide painted Bible-times courtyard with a family at far left and a grandmother with a girl at far right. Use stone homes, olive foliage, flowers, warm light, and a broad open center for the existing logo. Generate no lettering or logo. Place the unmodified logo proportionally in the center afterward.
- **Presentation background:** Create a wide calm slide background matching the cover. Reserve a broad pale cream and light blue center for dark text. Keep stone homes, olive leaves, clay pots, and flowers at the edges. Include no people, logo, or lettering.
